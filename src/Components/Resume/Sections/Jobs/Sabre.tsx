...
const Sabre = () => {
    ...
    const bullets = {
        ...
        a3: 'For every development, I created unit tests with Enzyme and Jest to self check my own code before being submitted to code review by my team.',
        ...
        b2: 'I examined the Jenkins pipeline with the team project leader. The project used Jenkins to automate their CI/CD. The pipeline was triggered by changes to the git branch, ' +
